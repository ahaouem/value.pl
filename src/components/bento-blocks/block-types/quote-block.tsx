    ...
    <>
      <div className="relative">
        <svg
          ...
          className="absolute -top-4 size-12 fill-emerald-400/25 dark:fill-emerald-400/10 lg:-left-4 lg:-top-12 lg:size-24"
        >
          <path
        ...
        <h2 className="text-balance text-left text-base/6 tracking-[-0.015em] text-green-900 dark:text-green-50">
          Today&apos;s Quote (kwəʊt)
        </h2>
        <p className="mt-px text-left text-base font-semibold italic text-green-900 dark:text-green-50 md:text-xl lg:text-3xl">
          {quote}
        </p>
      </div>
    </>
