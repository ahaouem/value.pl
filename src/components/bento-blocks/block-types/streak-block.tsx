export default function StreakBlock() {
  return (
    <div className="mx-auto max-w-md rounded-lg text-amber-950">
      <div className="lg:mb-6 flex lg:flex-col items-center justify-between">
        <h2 className="text-xl lg:text-2xl font-bold">Current Streak</h2>
        <div className="relative lg:mt-4 flex size-16 lg:size-24 items-center justify-center">
          <svg
          ...
          <div className="absolute inset-y-10 lg:inset-y-16 flex items-center justify-center text-center text-3xl font-bold">
            14
          </div>
        </div>
      </div>
